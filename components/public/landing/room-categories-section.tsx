...
export function RoomCategoriesSection() {
  return (
    <section className="bg-room-category-bg py-10 shadow-xl md:py-16">
      <div className="mx-auto w-full max-w-7xl px-4 md:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-2xl font-semibold uppercase md:text-4xl">The Apartments We Offer</h2>
          <p className="mt-2 text-sm text-muted-foreground md:text-2xl">
            Take a sneak peak into the apartments and suites that we offer at incredible prices Make
            your stay a memorable experience
          </p>
        </div>

        <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 md:mt-12 lg:grid-cols-4 lg:gap-4 xl:gap-6">
